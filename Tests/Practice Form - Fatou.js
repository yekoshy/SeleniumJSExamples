...
async function PracticeForm() {
    ...
    try{
        ...
        await driver.findElement(By.cssSelector("label[for='gender-radio-2']")).click();
        ...
        await driver.findElement(By.cssSelector("div[id^='react-select-3-option-0']")).click();
        await driver.findElement(By.cssSelector('#city .css-1hwfws3')).click();
